//
//  LookupInviteRuleTableViewController.m
//  DuoBao
//
...
@interface LookupInviteRuleTableViewController ()

@end

@implementation LookupInviteRuleTableViewController
...
- (void)viewDidLoad {
    ...
    UIImage *image = [UIImage imageNamed:@"lookupInviteRule"];
    UIImageView *imageView = [[UIImageView alloc] initWithImage:image];
    imageView.width = ScreenWidth;
    imageView.height = ScreenWidth * image.size.height / image.size.width;
