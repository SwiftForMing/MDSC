...
{
    if (!_itemTitle) {
        self.itemTitle = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_itemImg.frame) + 10, CGRectGetMidY(_itemImg.frame) - 10, ScreenWidth - 54, 20)];
...
- (void)setSubViews
{
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(_itemImg.frame) + 10, CGRectGetMaxY(_itemImg.frame) + 4, ScreenWidth - CGRectGetMaxX(_itemImg.frame) - 10, 1)];
