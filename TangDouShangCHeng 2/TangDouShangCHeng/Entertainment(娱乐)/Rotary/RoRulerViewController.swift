...
class RoRulerViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.rulerView = Bundle.main.loadNibNamed("RulerView", owner: self, options: nil)?.first as? RulerView
