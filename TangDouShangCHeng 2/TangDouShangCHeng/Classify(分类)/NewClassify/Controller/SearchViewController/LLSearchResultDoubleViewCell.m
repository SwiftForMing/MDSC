...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(kSpace, CGRectGetMaxY(_leftTitle.frame) + 9, ScreenWidth - kSpace * 2, 1)];
...
{
    if (!_rightImage) {
        self.rightImage = [[UIImageView alloc] initWithFrame:CGRectMake(ScreenWidth - kSpace - KWidth, 10, KWidth, KWidth)];
